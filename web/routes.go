...
func (s *Server) routes() *http.ServeMux {
	...
	mux.HandleFunc("GET /api/chats", s.handleChatListGet)
	mux.HandleFunc("POST /api/chats", s.handleChatCreate)
	mux.HandleFunc("GET /api/chats/{id}", s.handleChatGetOne)
	mux.HandleFunc("PATCH /api/chats/{id}", s.handleChatRename)
	mux.HandleFunc("DELETE /api/chats/{id}", s.handleChatDelete)
	...
	mux.HandleFunc("GET /memory", s.handleMemoryGet)
	mux.HandleFunc("POST /memory/prune", s.handleMemoryPrune)
	mux.HandleFunc("POST /memory/record/{id}/delete", s.handleMemoryDelete)
	mux.HandleFunc("GET /memory/backfill", s.handleMemoryBackfillFragment)
